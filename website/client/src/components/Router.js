...
const Router = () => {
 ...
 const addImage=(file)=>{
  ...
  return(<BrowserRouter basename='/'>
    ...
    <Route exact path="/comments-section" render={props=> <CommentSection baseImg={baseImg} response={response} addPost={addPost} addImage={addImage} currentID={currentID} />}/>
    <Route exact path="/gallery" render={props=> <Gallery responseImage={responseImage} loading={loading} load={load} />}></Route>
